...
class _AuthDataSource implements AuthDataSource {
  ...
  Future<RequestTokenModel> getRequestToken() async {
    ...
    final _options = _setStreamType<RequestTokenModel>(
  ...
  @override
  Future<SessionModel> getSessionId(String requestToken) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  @override
  Future<MessageModel> logout(SessionModel body) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
