...
class _MediaRemoteDataSource implements MediaRemoteDataSource {
  ...
  Future<MediaListResponseModel> getMediaList(
    ...
    final _options = _setStreamType<MediaListResponseModel>(
  ...
  Future<MediaDetailsResponseModel> getMediaDetails(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<MediaDetailsResponseModel>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
  ...
  Future<TvShowSeasonModel> getSeasonDetails(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<TvShowSeasonModel>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
