...
extension $LoginRouteExtension on LoginRoute {
  ...
  String get location => GoRouteData.$location(
        '/login/${Uri.encodeComponent(requestToken)}',
      );
...
RouteBase get $homeShell => StatefulShellRouteData.$route(
      ...
      branches: [
        StatefulShellBranchData.$branch(
          navigatorKey: MovieData.$navigatorKey,
          routes: [
            GoRouteData.$route(
              path: '/movie',
              name: 'movie',
        ...
        StatefulShellBranchData.$branch(
          navigatorKey: TvData.$navigatorKey,
          routes: [
            GoRouteData.$route(
              path: '/tv',
              name: 'tv',
        ...
        StatefulShellBranchData.$branch(
          navigatorKey: SearchData.$navigatorKey,
          routes: [
            GoRouteData.$route(
              path: '/search',
                ...
                GoRouteData.$route(
                  ...
                  routes: [
                    GoRouteData.$route(
                      ...
                      name: 'changeLanguage',
                      parentNavigatorKey:
                          ChangeLanguageRoute.$parentNavigatorKey,
...
extension $SeeMoreMoviesRouteExtension on SeeMoreMoviesRoute {
  static SeeMoreMoviesRoute _fromState(GoRouterState state) =>
      SeeMoreMoviesRoute(
        listType:
            _$ListTypeEnumMap._$fromName(state.pathParameters['listType']!),
...
extension $MediaDetailsRouteExtension on MediaDetailsRoute {
  static MediaDetailsRoute _fromState(GoRouterState state) => MediaDetailsRoute(
        ...
        listType: _$convertMapValue('list-type', state.uri.queryParameters,
...
extension $TrailerRouteExtension on TrailerRoute {
  static TrailerRoute _fromState(GoRouterState state) => TrailerRoute(
        ...
        official: _$convertMapValue(
            'official', state.uri.queryParameters, _$boolConverter),
      );
...
extension $AccountMediaListRouteExtension on AccountMediaListRoute {
  ...
  String get location => GoRouteData.$location(
        '/accountList',
        queryParams: {
          'list-type': _$ListTypeEnumMap[listType],
        },
      );
